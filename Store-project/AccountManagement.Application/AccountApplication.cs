...
namespace AccountManagement.Application
{
    public class AccountApplication : IAccountApplication
    {
        ...
        public OperationResult Register(RegisterAccount command)
        {
            ...
            var account = new Account(command.Name,command.Family,command.Email, command.Username, password, command.Mobile, command.RoleId,
                picturePath);
        ...
        public OperationResult Edit(EditAccount command)
        {
            ...
            var path = $"profilePhotos";
            var picturePath = _fileUploader.Upload(command.ProfilePhoto, path);
            account.Edit(command.Name,command.Family,command.Email, command.Username, command.Mobile, command.RoleId, picturePath);
            _accountRepository.SaveChanges();
            return operation.Succedded();
        }
        ...
        public OperationResult Login(Login command)
        {
            ...
            var authViewModel = new AuthViewModel(account.Id, account.RoleId, account.Name,account.Family,account.Email
